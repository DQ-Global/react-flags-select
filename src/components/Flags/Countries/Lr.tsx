...
const SvgLr = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill="none">
      <path
        fill="#FF4B55"
        d="M512.001 30.771H0V9.103A8.83 8.83 0 0 1 8.828.275h494.345a8.83 8.83 0 0 1 8.828 8.828z"
      />
      ...
      <path
        fill="#FF4B55"
        d="M512 152.753H8.828A8.83 8.83 0 0 1 0 143.925v-21.667h512z"
      />
      ...
      <path
        fill="#FF4B55"
        d="M503.172 335.724H8.828A8.83 8.83 0 0 1 0 326.896v-21.667h512v21.667a8.83 8.83 0 0 1-8.828 8.828"
      />
      <path
        fill="#41479B"
        d="M141.241 152.753H8.828A8.83 8.83 0 0 1 0 143.925V9.103A8.83 8.83 0 0 1 8.828.275h132.414a8.83 8.83 0 0 1 8.828 8.828v134.822a8.83 8.83 0 0 1-8.829 8.828"
      />
      <path
        fill="#F5F5F5"
        d="m72.512 39.737-8.428 25.27-26.638.206c-2.554.02-3.614 3.279-1.559 4.797l21.429 15.825-8.035 25.398c-.77 2.435 2.003 4.45 4.081 2.965l21.674-15.49 21.672 15.49c2.078 1.485 4.851-.53 4.081-2.965l-8.035-25.398 21.429-15.825c2.055-1.517.995-4.778-1.559-4.797l-26.638-.206-8.428-25.27c-.81-2.424-4.237-2.424-5.046 0"
      />
    </g>
  </svg>
);
