...
const SvgGw = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill="none">
      ...
      <path
        fill="#464655"
        d="m82.197 123.959-9.731 29.18-30.759.238c-1.686.013-2.386 2.165-1.028 3.167l24.744 18.272-9.278 29.326c-.509 1.608 1.322 2.937 2.694 1.958l25.024-17.886 25.024 17.887c1.372.981 3.202-.35 2.694-1.957l-9.278-29.326 24.744-18.272c1.356-1.002.658-3.154-1.028-3.167l-30.759-.238-9.731-29.18c-.536-1.601-2.798-1.601-3.332-.002"
      />
    </g>
  </svg>
);
