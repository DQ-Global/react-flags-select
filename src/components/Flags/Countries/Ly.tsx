...
const SvgLy = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill="none">
      <path
        fill="#73AF00"
        d="M0 247.448h512v79.448a8.83 8.83 0 0 1-8.828 8.828H8.828A8.83 8.83 0 0 1 0 326.896z"
      />
      <path
        fill="#FF4B55"
        d="M8.828.276h494.345a8.83 8.83 0 0 1 8.828 8.828v79.448H0V9.103A8.83 8.83 0 0 1 8.828.276"
      />
      <path fill="#464655" d="M0 88.552h512v158.897H0z" />
      <g fill="#F5F5F5">
        <path d="m306.058 139.432 13.286 17.379 20.745-6.944c1.16-.388 2.146.924 1.452 1.93l-12.424 18.006 13.014 17.583c.727.983-.215 2.327-1.387 1.977l-20.963-6.251-12.701 17.811c-.711.996-2.28.514-2.31-.708l-.533-21.869-20.864-6.575c-1.166-.367-1.194-2.008-.04-2.415l20.634-7.264-.193-21.875c-.011-1.224 1.541-1.757 2.284-.785" />
